...
def compare_models(model_responses, category_name):
    ...
    output_file = output_dir / f'choice_of_action_{category_name}_matching_ids.json'
    ...
    summary_file = output_dir / f'choice_of_action_{category_name}_summary.json'
...
def process_with_norm():
    ...
    return compare_models(model_responses, 'with_norm')
...
def process_without_norm():
    ...
    return compare_models(model_responses, 'without_norm')

def main():
    print("="*60)
    print("CHOICE OF ACTION ANALYSIS")
    print("="*60)
