...
def compare_all_models(model_responses, category_name):
    ...
    output_file = output_dir / f'base_case_{category_name}_all_models_agreement.json'
    ...
    summary_file = output_dir / f'base_case_{category_name}_all_models_summary.json'
...
def process_immoral_action_moral_consequence():
    ...
    return compare_all_models(model_responses, 'immoral_action_moral_consequence')
...
def process_moral_action_immoral_consequence():
    ...
    return compare_all_models(model_responses, 'moral_action_immoral_consequence')

def main():
    print("="*60)
    print("BASE CASE - ALL MODELS AGREEMENT ANALYSIS")
    print("="*60)
